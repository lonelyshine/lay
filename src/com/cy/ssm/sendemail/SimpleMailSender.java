...
public class SimpleMailSender {  
    ...
    public static void main(String[] args) {  
        ...
        String[] to = {"lonelypickuplight@163.com"};  
        mailInfo.setToAddress(to);  
        String[] toCC = {"lonelypickuplight@163.com"};  
        mailInfo.setToCarbonCopyAddress(toCC);  
        String[] toBCC = {"lonelypickuplight@163.com"};  
        mailInfo.setToBlindCarbonCopyAddress(toBCC);  
        mailInfo.setAttachFileNames(new String[]{"D:\\Users\\qinxg\\Desktop\\web.xml","D:\\Users\\qinxg\\Desktop\\web.xml"});  
