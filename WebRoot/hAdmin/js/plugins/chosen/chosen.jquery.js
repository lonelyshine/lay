 ...
 * 
 * Version 1.1.0 Full source at https://github.com/harvesthq/chosen Copyright
 * (c) 2011 Harvest http://getharvest.com
 * 
			...
			for (_i = 0, _len = _ref.length; _i < _len; _i++) {
				...
				if (this.include_option_in_results(option)) {
					...
					if (!(option.group && !this.group_search)) {
						option.search_text = option.group
								? option.label
								: option.html;
			...
			if (el.length) {
				...
				if (high_bottom >= visible_bottom) {
					return this.search_results
							.scrollTop((high_bottom - maxHeight) > 0
